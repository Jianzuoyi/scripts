...
def main():
	...
	parser.add_argument('-nr','--noreqsub',help='do not reqsub failed jobs, [NO]', dest='noreqsub', action='store_true')
	...
	parser.add_argument('-quota', '--quota', help='disk quota, [100000000000000000G]', dest='quota' , default='100000000000000000G')
	...
	debug_log.info('generate job done')
	modify_job_object( obj_dict , args )
	#print( obj_dict )
	if args.goon:
		check_obj_status(obj_dict ,  args.input)
	debug_log.info('modify job status done')
